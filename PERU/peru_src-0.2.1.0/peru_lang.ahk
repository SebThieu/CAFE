...
;internationalisation
	...
	; ##################################################################
	Iniread, relaneccafe, %lng%, tray, relaneccafe, Relancer P.E.R.U.
	Iniread, cafecorb, %lng%, tray, cafecorb, Corbeille de P.E.R.U..
	...
	; traytooltip
	Iniread, cafeoperationel, %lng%, traytip, cafeoperationel, P.E.R.U.. est opérationel
	Iniread, utilisationpossible, %lng%, traytip, utilisationpossible, Vous pouvez maintenant l'utiliser
	Iniread, enpause, %lng%, traytip, enpause, Mise en pause de P.E.R.U..
	Iniread, actif, %lng%, traytip, actif, Activation de P.E.R.U..
	...
	Iniread, majinutile, %lng%, messages, majinutile, Vous disposez déjà de la dernière version disponible de P.E.R.U..
	...
	Iniread, logicielintrouvable3, %lng%, messages, logicielintrouvable3, Le logiciel est introuvable.Vérifiez le fichier de configuration.
	
	; ##################################################################
	Iniread, cafeerreur, %lng%, messages, cafeerreur, P.E.R.U..|ERREUR
	Iniread, cafeinfo, %lng%, messages, cafeinfo, P.E.R.U..|INFO
	...
	Iniread, labelcheminabs, %lng%, appgui, labelcheminabs, Chemin vers l'application
	Iniread, titregui, %lng%, appgui, titregui, P.E.R.U. |Configuration des applications liées
	Iniread, titreguiapp, %lng%, appgui, %titreguiapp%, P.E.R.U. | Configurer les applications liées
	...
	Iniread, boxappassext, %lng%, appgui, boxappassext, Extensions
	...
	Iniread, titregui, %lng%, extgui, titregui, P.E.R.U. |Configurer les associations
	...
	IniRead, hktitlegui, %lng%, hkgui, hktitlegui,  P.E.R.U.. | Configuration des raccourcis claviers
