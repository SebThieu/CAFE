...
Gui, Add, Hotkey, x+10 y310 vhotkeychoosed,
Gui, Add, CheckBox, x+5 y313 vchkwin, +Win
Gui, Add, Button, x+5 y310 gChooseHotKey, >
Gui, Add, Edit, x+5 w100 vChosenHotkey
...
Gui,Add, Button, x380 y370 w90 h30 gGuiClose, %boutonquitter%
Gui,Show,, %hktitlegui%
Gosub, Refresh_HK_Gui
Return

ChooseHotKey:
GuiControlGet, hk,, hotkeychoosed
GuiControlGet, var,, chkwin
hk:=HK_AHK2Cafe(hk)
If ( var = "1" )
{
	hk := "Win+" . hk
